...
- All the available extracurricular activities and jobs are on display across the Biblioplex. Each student should be encouraged to get involved in at least one (with a maximum of two allowed).
...
|------------------------------------|----------------------------------------------------------------------------------------------------------------------------|---------------------------------------|------|
| Biblioplex                         | Book clerk, book shelver, cafe worker, cleanup crew member, garden tender, store worker                                    | Drazhomir Yarnask                     |      |
| Bow’s End Tavern                   | Assistant manager, cleanup crew member, cook, host, server                                                                 | Javenesh Stoutclaw                    |      |
| Campus Grounds                     | Graffiti eraser, lawn manicurist, litter retriever, sidewalk sweeper, statuary repairer, trash collector                   | Shuvadri Glintmantle                  |      |
| Campus Magic Labs                  | Cleanup crew member, specimen preparer, volunteer lab partner                                                              | Urzmaktok Grojsh                      |      |
| Dormitories                        | Cleanup crew member, events assistant, front desk worker, resident assistant                                               | Nora Ann Wu                           |      |
| Firejolt Cafe                      | Barista, cashier, cleanup crew member, server                                                                              | Mina Lee                              |      |
| Intramural Fields                  | Cleanup crew member, crowd manager, equipment assistant, groundskeeper, referee                                            | Rosimyffenbip “Rosie” Wuzfeddlims     |      |
| Strixhaven Performing Arts Society | Cleanup crew member, general assistant, refreshments expert, stagehand, ticket taker, usher                                | Larine Arneza                         |      |
| Strixhaven Stadium                 | Cleanup crew member, entertainment assistant, equipment assistant, groundskeeper, refreshments expert, ticket taker, usher | Aurora Luna Wynterstarr, Greta Gorunn |
