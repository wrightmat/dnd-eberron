...
* PCs enter a large chamber with a floor of ice, but they don't see anything else around them. In order to advance, the players will need to break or chisel through the ice in some way, to access the pool of water underneath. Once they can see under the ice, they'll notice that there's a doorway on the floor of the pool that appears to lead out of the room.
...
* Deep within the cavern, the players discover a forge filed with blue flames, radiating intense heat amid the icy environment. A powerful crystalline guardian stands watch over the forge, ready to challenge any intruders.
