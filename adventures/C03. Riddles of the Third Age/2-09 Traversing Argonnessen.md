...
* Mass combat against topaz dragons, ala Warriors of Krynn.

 - [ ]  **Tiamat's Temple**

* Use most of the content from Tiamat's Temple from Rise of Tiamat, replacing its cult assets with the dragon faction leaders, and the sacrifices with members of the Orders. Still use the ideas behind the "Weakening the Dragon Queen" section, but adjust as needed - including incorporating the Draakhorn.
