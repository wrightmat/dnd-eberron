...
**Creatures**. An elite squad of three kobolds patrols the hall, considering the duty an honor. The guards pay particular attention to the door that leads to area 19, which is along the route traditionally used by orc raiders. These kobolds react to the character's presence in the same way as the ordinary ones described previously. If the characters head for area 21 without causing hostilities, these guards follow the characters into Yusdrayl's presence.
...
**Creatures**. Dragonleaf Tree (ToB1)? CR 8
...
* Monsters: Blemmyes (ToB1, CR 8), Drakon (ToB1, CR 5), Mindrot Thrall (ToB1, CR 3), Miremal (ToB1, CR 1/2), Moss Lurker (ToB1, CR 1), Skitterhaunt (ToB1, CR 4), Treant Weeping (ToB1, CR 6), Bulbous Violet (ToB2, CR 1), Ooze Mineral (ToB2, CR 3), Swamp Naga (ToB2), Quickserpent (ToB2)
