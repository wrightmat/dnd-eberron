...
* Monsters: Blemmyes (ToB1, CR 8), Drakon (ToB1, CR 5), Mindrot Thrall (ToB1, CR 3), Miremal (ToB1, CR 1/2), Moss Lurker (ToB1, CR 1), Skitterhaunt (ToB1, CR 4), Treant Weeping (ToB1, CR 6), Bulbous Violet (ToB2, CR 1), Ooze Mineral (ToB2, CR 3), Swamp Naga (ToB2)
...
| dice: 1d8 | Mystic Glade Prophesies |
| --------- | ----------------------- |
| 1         |                         |
| 2         |                         |
| 3         |                         |
