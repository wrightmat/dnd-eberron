...
* The labyrinth operates on ten minute exploration rounds as the players take actions and navigate the maze, but it always takes a full hour to move between areas. Every hour (use a d6 as a countdown timer), the labyrinth's guardian (the Metal Minotaur, see below for details) makes a move closer to the PCs.
...
| 6-8       | Baalo One-Eye and his Khraal Lords (or, alternatively, Avarice and her party) confront the party. |
^khraal-encounters
