...
- As they leave, the players find that the temple has shifted, no... actually flipped upside down! As they make their way back toward the entrance, all of the previous rooms have been replaced with studies and other rooms containing lawful priests in misty blue robes (known as Incarnum Hierarchs), who refuse to speak.
- The previous Sacrificial Altar room now contains a large misty blue-green gem, which addresses the players when they enter. It tells them they are in the Temple of Mana Incarnate, and that it is an Eidolon (dedicated to law) that can answer any question they may think of.
