...
##### 2: Finding the Sphinx's Lair
 ...
 - [x]  **Navigating the Endwall Mountains**
...
- Ritual components are hidden in various parts of the coliseum, requiring Intelligence (Investigation) checks (DC 14) to locate (then placed in a random location by the DM), and avoiding the undead monsters to collect. Completing the ritual involves collecting all of the components, and then completing a sequence of an Intelligence (Arcana) check (DC 16) and a Wisdom (Religion) check (DC 18) to properly channel the energies.
	...
	- **Forgotten Soulshard** (red): A glowing crystal that pulses with a faint heartbeat, rumored to hold the soul of a long-forgotten hero.
...
- Upon successful completion of the ritual, instead of ceasing, the energy stabilizes and culminates in the release of a more powerful undead creature (Nihilethic Dominator).

`encounter: 1d20+2: Skeleton`
`encounter: 1d12+2: Shadow`
`encounter: 1d8+2: Specter`
`encounter: 1d6+2: Ghast`
`encounter: 1: Nihilethic Dominator`

 - [x]  **6. The Dust of Ages**
...
>"Through gates of bone and halls of dread, lead us where living fear to tread. Guide our souls, forever roam, within your halls we find our home."
...
| 3         | `encounter: 1d3: Ogre`             |
| 4         | `encounter: 1d3: Anubian`          |
