...
* Second, the Young Dragon units, with Morale based on Faction Morale (9 units versus whatever remains of 13 PC units):
	...
	* Copper (+8)
	* Gold (+6)
* Finally, the Adult Dragon units (where leaders are able to fight), with Morale based on Faction Morale (7 units versus whatever remains of 13 PC units):
	* Black (+7)
	* Green (+7)
	* Blue (+9)
	* Brass (+8)
...
| 8-11   | `encounter: 4: Topaz Dragon Wyrmling` |
| 12-15  | `encounter: 1: Young Topaz Dragon`    |
| 16+    | `encounter: 2: Young Topaz Dragon`    |
