...
* **The Vault**. Frostmantle's premier destination for general goods, curios, and the occasional rare item that no one else seems to be able to find.
	* [[Shop - The Vault]]
* **Temple of the Sovereign Host**. This temple is already teaching the Thir beliefs and is adorned with draconic symbology. The priest is a member of the Order of the Ruby Scale.
* **Kundarak Bank**. 
