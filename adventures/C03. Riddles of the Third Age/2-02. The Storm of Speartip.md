...
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1          | Magical Storm brews. Roll on the Magical Storm table to determine the effect.                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| 4          | Ghost Fog rolls in. Every hour a ship is immersed in ghost fog, roll any die. On an even number, 2d4 hostile specters appear and attack those on the ship. If a humanoid creature dies in ghost fog, its spirit rises as a specter that is hostile toward all creatures that aren't undead. All non-undead creatures immersed in ghost fog are vulnerable to necrotic damage.                                                                                                                               |
| 5          | Lightning strikes the ship, causing 1d8 lightning damage. DC 14 Dexterity save to avoid taking damage (but the ship always takes it). A failure of 5 or more results in that character being Stunned for 1d4 rounds. A critical hit (8 on the damage die) results in the ship catching fire.                                                                                                                                                                                                                |
| 6          | A wave crashes against the ship, rocking it back and forth. DC 12 Strength save, or fall prone and take 1d6 bludgeoning damage from the water. Any officer knocked prone uses their full action to get up on their next turn, unless assisted.                                                                                                                                                                                                                                                              |
| 7          | A whirlpool appears directly under the ship. Whirlpools are difficult terrain. Roll a d4 to determine its rank (and see Ghosts of Saltmarsh, pg 206, for details).                                                                                                                                                                                                                                                                                                                                          |
| 8          | A current appears near the ship, carrying the ship with it. Roll a d8 to determine the direction, and a d6 to determine the speed (multiplied by ten, in feet per round). The current remains for 1d4 round.                                                                                                                                                                                                                                                                                                |
| 9          | Wind changes direction and/or speed. Roll a d8 to determine the direction, and a d6 to determine the speed (in miles per hour).                                                                                                                                                                                                                                                                                                                                                                             |
...
* Magical Storm rules, Ghosts of Saltmarsh, pg 205
