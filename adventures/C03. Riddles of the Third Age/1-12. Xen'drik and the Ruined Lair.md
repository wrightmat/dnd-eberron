...
### Scenes and Situations
 ...
 - [x]  **Attack on Morgrave University**
...
* Once the players return and place all of the orbs in the appropriate statue's hand, a stone staircase downward appears in the ground (leading to the Former Chamber of the Oracular Guardian below).
 ...
 - [x]  **1 - Strength**: The Hall of Might
...
* One player will need to man the bellows, succeeding on DC 15 Strength (Athletics) checks in order to keep the fire going. Another player will need to man the anvil, succeeding on two successful DC 12 Strength (Sleight of Hand) checks (adding proficiency with Smith Tools, if applicable) before two failures - which would cause the sphere to shatter, requiring the player to start over.
 ...
 - [x]  **2 - Dexterity**: The Chamber of Agility
...
* An ability challenge of Dexterity checks, requiring two successes. Players can use any Dexterity-based checks (especially skills usually based on other abilities) that they can justify. For example, using Dexterity (Performance) might entail flipping over and through beams, like an action movie.

`encounter: 1: Prismatic Beetle Swarm`

 - [x]  **3 - Constitution**: The Poison Vault of Endurance
...
* For each round that any PC is exposed to the gas, they take `dice:1d4` poison damage; any breathing in the poisonous gas take `dice:1d12` poison damage. Each round that any PC is holding their breath, they'll need to make a Constitution save against the poisonous gas (DC is 10 + the last damage taken). On a failure, they stop holding their breath and immediately start taking additional damage from the gas.
 ...
 - [x]  **4 - Intelligence**: The Tendril Test
...
* A blue orb sits on a pedestal in the center of a 40 foot wide square room. When anyone approaches within 10 feet of the pedestal, black tendrils rise from each 5-foot square of the floor and grope blindly at creatures in the room. Any player moving within that space must make a DC 12 Intelligence (Nature) check to determine if they're touched by a tendril. Anyone touched by a tendril loses one point of Intelligence (until a long rest or a restoration spell).
 ...
 - [x]  **5 - Wisdom**: Mouse/rat Challenge
...
`encounter: 1d6: Musteval Guardinal`
 ...
 - [x]  **6 - Charisma**: The Court of Shadows

>The room is dimly lit, with ethereal shadows flitting across the walls. A purple orb is held aloft in the room's center, bound by chains of shadow. Suddenly, a circle of shadowy figures, an otherworldly audience, appears in the center of the room.
>The largest one addresses you: "We are the Court of Shadows. We seek something that only living beings can offer - a story, a memory, or a promise of a deed to be done in our name."
...
* If the shadows are satisfied with the offering, they release the orb. If not, they may demand a higher price or a different type of story, possibly leading to a series of increasingly personal tales until one finally wins their favor.
 ...
 - [x]  **Former Chamber of the Oracular Guardian**
...
* There's also a side table with a notebook on it, scribbled with ancient notes from Flamewind herself. Inside is the Lantern of Seeking command word for Giants (which the players can decide), as well as a key for holographic projection and the aura color (purple is lowest power, and red is highest and most dangerous).

>_A flickering image of Flamewind appears, casting ethereal light around her former lair. The air hums with ancient magic as her voice, both warm and solemn, fills the chamber._
>"Brave souls, though my essence has merged with the winds of time, my spirit remains entwined with the threads of our shared destiny. You stand at a precipice, gazing into the abyss that threatens to engulf the world in its shadow. The map before you, a tapestry woven from the very essence of magic itself, holds the key to thwarting the dark designs set into motion by the scaled tyrants from beyond."
>_The image of a map materializes, glowing spherical auras indicating locations across Eberron._
>"Each point of light, represents an artifact of ancient power, born from the chaos and order that form the heartbeat of our world. These relics, scattered by the whims of fate, are the keys to sealing the breach that would unleash Tiamat's fury upon us all."
>"Do not falter, for the path is treacherous, and the agents of chaos are myriad. Yet, remember, it is in the balance between light and shadow that true power lies. Your journey will take you to the corners of Eberron, from the depths of Khyber to the peaks of Argonnessen. Trust in each other, and in the strength that resides within you."
>"Though I cannot stand by your side in this battle, my faith in you is unwavering. You are the chosen, the bearers of the flame that will light our darkest hour. It is not the might of the magic you wield, but the strength of your convictions, the courage to stand for what is right, that will guide you through the storm."
>_The image of Flamewind takes a more solemn, personal tone._
>"In my time, I have seen empires rise and fall, stars born and extinguished. Yet, it is in moments like these, where the fate of the world hangs by a thread, that true heroes are forged. You have been chosen, not by accident, but by destiny. The road ahead is fraught with peril, but it is yours to walk. And know this, you do not walk it alone."
>_With a final, compassionate look, Flamewind's image fades, leaving only the glowing map and a sense of profound purpose._

* Before they leave, big cats (one for each member of the party) with similar coloration to Flamewind and adorned with gold, attack the party. If searched, one has a diamond worth 300 gp, and each has another 100 gp worth of gold adornment.

`encounter: 4: Bastet Temple Cat`

[[Future Adventure Concepts]]
