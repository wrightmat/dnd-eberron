...
actions:
  ...
  - name: Shortsword.
    desc: "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 6 (1d6 + 3) piercing damage plus 10 (3d6) damage of the type to which the dragonsoul has resistance."
  - name: Orb of Dragon's Breath (3/Day).
    desc: "Ranged Spell Attack: +7 to hit, range 90 ft., one target. Hit: 27 (6d8) damage of the type to which the dragonsoul has damage resistance."
```

### References

* Rise of Tiamat, page 89
* Tyranny of Dragons, page 183
