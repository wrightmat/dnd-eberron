...
| dice: 1d100  | Encounter                                                     |
|-------|---------------------------------------------------------------|
| 01-10 | `encounter: 3d6: Quipper`                                                  |
| 11-14 | `encounter: 2d4: Steam Mephit`                                             |
| 15-18 | `encounter: 1d4: Sahuagin`                                                  |
| 19-22 | `encounter: 2d6: Merfolk`                                                   |
| 23-25 | `dice: 2d4` corpses of drowned sailors tangled in kelp                |
| 26-29 | `encounter: 2d4: Constrictor Snake`                                        |
| 30-33 | `encounter: 1d4: Reef Shark`                                               |
| 34-37 | `encounter: 1 Swarm of Quippers`                                           |
| 38-40 | A bed of enormous clams                                       |
| 41-45 | `encounter: 1d10: Merfolk, 1d3: Giant Sea Horse`                        |
| 46-50 | `encounter: 1: Giant Octopus`                                               |
| 51-55 | `encounter: 1: Merrow`                                                      |
| 56-60 | `encounter: 1: Plesiosaurus`                                                |
| 61-65 | `dice:2d10` pieces of corroded brass dinnerware littering the bottom |
| 66-70 | `encounter: 1: Giant Constrictor Snake`                                     |
| 71-75 | `encounter: 1: Sea Hag`                                                     |
| 76-80 | A school of silvery fish darting through the water            |
| 81-85 | `encounter: 1d4: Hunter Sharks`                                             |
| 86-90 | `encounter: 1: Sahuagin Priestess, 2d4: Sahuagin`                        |
| 91-96 | `encounter: 1d4: Killer Whale`                                             |
| 97-98 | `encounter: 1: Giant Shark`                                                 |
| 99    | `encounter: 1: Water Elemental`                                             |
| 00    | `encounter: 1: Sahuagin Baron`                                              |
...
| 82    | `encounter: 1: Vampire Spawn`                                                            |
| 83    | `encounter: 1: Couatl`                                                                   |
| 84    | `encounter: 1: Ghost`                                                                    |
| 85    | `encounter: 1: Succubus` or `encounter: 1: Incubus`                                                    |
| 86    | `encounter: 1: Bandit Captain, 3d6: Bandit`                                          |
| 87    | `encounter: 1d4 + 1: Cult Fanatic`                                                      |
| 88    | `encounter: 1: Knight` or `encounter: 1: Veteran`                                                      |
| 89    | `encounter: 1: Water Weird`                                                              |
| 90    | `encounter: 1: Wight`                                                                    |
| 91    | `encounter: 1: Mage`                                                                     |
| 92    | `encounter: 1: Shield Guardian`                                                          |
| 93    | `encounter: 1: Gladiator`                                                                |
| 94    | `encounter: 1: Revenant`                                                                 |
| 95    | `encounter: 2d4: Gargoyle`                                                              |
| 96    | `encounter: 1d4: Doppelganger`                                                          |
| 97    | `encounter: 1: Oni`                                                                      |
| 98    | `encounter: 1: Invisible Stalker`                                                        |
| 99    | `encounter: 1d3 + 1: Phase Spider`                                                      |
| 00    | `encounter: 1: Assassin`                                                                 |
^encounter-urban-1-4
